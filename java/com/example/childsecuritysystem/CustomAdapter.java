...
////////////////Delete Child////////////////////////////////
    ...
    public void onClick(View v) {
        ...
        String url = "user/DeleteUser?id="+dataModel.U_ID;
        CallResult result = WCFHandler.GetJsonResult(url);
        if(result.StatusCode==200) {
            dataSet.remove(position);
            notifyDataSetChanged();
            Snackbar.make(v, "Child Delete Successfully " + dataModel.getFeature(), Snackbar.LENGTH_LONG)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtName.setText(dataModel.U_Name);
        viewHolder.txtType.setText(dataModel.C_Phone_No);
